        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm btn-primary"
                   href="${pageContext.request.contextPath}/clientes?action=editar&id=<%= c.getId() %>">Editar</a>
                <a class="btn btn-sm btn-danger"
                   href="${pageContext.request.contextPath}/clientes?action=eliminar&id=<%= c.getId() %>"
